    ...
    <div class="content container-fluid">
		...
		<div class="page-header">
			<div class="row align-items-center">
				<div class="col-md-4">
					<h3 class="page-title">{{ __('change_password') }}</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
						<li class="breadcrumb-item active">{{ __('change_password') }}</li>
					</ul>
				</div>
			</div>
		</div>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
				<form id="frmChangePassword" action="{{ route('admin.change-password-save') }}">
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="success-message text-center">
					...
					<h3>{{ __('Password updated successfully') }}!!!</h3>
				</div>
			</div>
		</div>
	</div>
