...
<div class="page-wrapper">
								...
								<td class="text-end">
									<div class="dropdown dropdown-action">
										...
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item edit-product-code" href="{{ route('email-management-edit', $val->id) }}"><i class="fa-solid fa-pencil m-r-5"></i> Edit</a>
										</div>
									</div>
								</td>
							</tr>
	...
	<!-- /Page Content -->
@include('admin.modal.email-management-modal')
