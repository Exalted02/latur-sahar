<div class="modal custom-modal fade" id="delete_ward_prabhag" role="dialog">
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="success-message text-center">
					...
					<p>{{ __('Ward prabhag') }} "<span id="list_code_name"></span>" {{ __('from your account') }}</p>
					<div class="col-lg-12 text-center form-wizard-button">
						<a href="#" class="button btn-lights" data-bs-dismiss="modal">{{ __('not now') }}</a>
						<a href="javascript:void(0);" class="btn btn-primary data-id-pcode-list" data-url="{{ route('admin.deleteWardprabhagList') }}">{{ __('okay') }}</a>
					</div>
				</div>
			</div>
		</div>
...
<!-- Add product code -->
<div id="add_ward_prabhag" class="modal custom-modal fade" role="dialog">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">{{ __('Add ward prabhag') }}</h5>
								<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
							<div class="modal-body">
								<form id="frmwardprabhag" action="{{ route('admin.save-ward-prabhag') }}">
								<input type="hidden" id="id" name="id">
									...
									<div class="submit-section">
										<button class="btn btn-primary submit-btn save-ward-prabhag" type="button">Submit</button>
									</div>
								</form>
							</div>
						</div>
