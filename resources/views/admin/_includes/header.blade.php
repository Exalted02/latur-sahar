...
<div class="header">
	...
	<ul class="nav user-menu">
		...
		{{--<li class="nav-item">
			<div class="top-nav-search">
				...
				<form action="search.html">
					<input class="form-control" type="text" placeholder="{{ __('search') }} {{ __('here') }}">
		...
		{{--<li class="nav-item dropdown has-arrow flag-nav">
			...
			<img src="{{ asset('admin-assets/img/flags/' . $languages[$selectedLang]['flag']) }}" alt="Flag" height="20">
			...
			<div class="dropdown-menu dropdown-menu-right languageChange">
				<a href="javascript:void(0);" class="dropdown-item" data-id="en">
					<img src="{{ asset('admin-assets/img/flags/us.png') }}" alt="Flag" height="16"> English
				</a>
				<a href="javascript:void(0);" class="dropdown-item" data-id="fr">
					<img src="{{ asset('admin-assets/img/flags/fr.png') }}" alt="Flag" height="16"> French
				</a>
				<a href="javascript:void(0);" class="dropdown-item" data-id="it">
					<img src="{{ asset('admin-assets/img/flags/it.png') }}" alt="Flag" height="16"> Itally
				</a>
				<a href="javascript:void(0);" class="dropdown-item" data-id="de">
					<img src="{{ asset('admin-assets/img/flags/de.png') }}" alt="Flag" height="16"> German
				</a>
			</div>
		</li>--}}
		<!-- /Flag -->
		...
		<li class="nav-item dropdown has-arrow main-drop">
			<a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
				<span class="user-img"><img src="{{ asset('/admin-assets/img/avatar/avatar-19.jpg') }}" class="mt-1" alt="img">
