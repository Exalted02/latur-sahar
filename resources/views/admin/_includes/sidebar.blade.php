		...
		<div id="sidebar-menu" class="sidebar-menu">
			<nav class="greedys sidebar-horizantal">
				<ul class="list-inline-item list-unstyled links">
					...
					<li class="submenu">
						<a href="#"><i class="la la-dashcube"></i> <span> Dashboard_sss</span> <span class="menu-arrow"></span></a>
						<ul>
	...
	<div class="sidebar sidebar-twocol">
		<div class="sidebar-left slimscroll">
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
				...
				<a class="nav-link active" id="v-pills-leads-tab" title="CRM" data-bs-toggle="pill" href="#v-pills-leads" role="tab" aria-controls="v-pills-leads" aria-selected="false">
					<span class="material-icons-outlined">
						leaderboard
					</span>
				</a>
			...
			<div class="tab-content" id="v-pills-tabContent">
				...
				<div class="tab-pane fade" id="v-pills-apps" role="tabpanel" aria-labelledby="v-pills-apps-tab">
					...
					<ul>
						...
						{{--<li>
							<a href="{{ route('user.contact') }}">Contacts</a>
						</li>--}}
						<li>
				...
				<div class="tab-pane fade show active" id="v-pills-leads" role="tabpanel" aria-labelledby="v-pills-leads-tab">
					<p>CRM</p>
					<ul>
					{{--<li>
							<a href="{{ route('user.contact') }}" class="active"> Contacts</a>
						</li>--}}
						<li>
