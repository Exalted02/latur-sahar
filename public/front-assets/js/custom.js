...
(function($) {
  ...
  /* ======= Animation ======= */
	...
	$('#price-slider').noUiSlider({
		...
		$('#price-slider').Link('lower').to($('#price-min1'), null, wNumb({
			decimals: 0
		}));
		$('#price-slider').Link('upper').to($('#price-max2'), null, wNumb({
			decimals: 0
		}));
		
		/*==========  Year Range Slider  ==========*/
	
		$('#yr-slider').noUiSlider({
			connect: true,
			behaviour: 'tap',
			margin: 5,
			start: [1995, 2019],
		...
		$('#yr-slider').Link('lower').to($('#yr-min'), null, wNumb({
			decimals: 0
		}));
		$('#yr-slider').Link('upper').to($('#yr-max'), null, wNumb({
			decimals: 0
		}));
		
		$('#yr-slider').Link('lower').to($('#yr-min1'), null, wNumb({
			decimals: 0
		}));
		$('#yr-slider').Link('upper').to($('#yr-max2'), null, wNumb({
			decimals: 0
		}));
